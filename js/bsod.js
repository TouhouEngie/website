...
const messages = ["I believe the Raspberry Pi has burst into flames.", "What do you mean the fileserver has a power budget? This isn't FNAF, right?", "HATE. LET ME TELL YOU HOW MUCH I'VE COME TO HA-*drowning intensifies*", "I think corporate is allergic to fun."];
var buffer = [];
var buffer2 = [];
