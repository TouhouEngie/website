...
var deez = new Date();
var tempAuthorString = ""; // where the hell else am i to put this without having errors thrown at my face (music.js)
...
async function galleryStart() {
  ...
  function setGalleryContent(inputArray, index) {
    ...
    if (inputArray[index].isFolder) {
      ...
      newEntry.on("click", function() {
        openBlankWindow(setFileSource(inputArray, index));
      });
    }
